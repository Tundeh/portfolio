    ...
    <div className="about">
      <div className="inner-content">
        <div className="intro">
          ...
          <p>
            Hello! I'm Jamiu Tunde Suleiman a Software Engineer, skilled in
            designing, building and deployment of front end and backend of web
