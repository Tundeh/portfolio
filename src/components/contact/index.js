  ...
  render() {
    ...
    return (
      <div className="contact" id="contact">
        ...
        <p>
          Think i'm qualified for a position <br></br> or you have a job for me?
          contact me!
        </p>
        <div className="contact__inner">
          <form
            ...
            action="https://formspree.io/mzbkzdpz"
            method="POST"
          >
            ...
            {status === "ERROR" ? (
              <div className="form__error">Unsuccessful, Try Again</div>
            ) : (
              <></>
            )}
          </form>
